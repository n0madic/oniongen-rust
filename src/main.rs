...
const RERANDOMIZE_INTERVAL: u64 = 1_000_000;
...
impl AddressMatcher {
    ...
    #[inline]
    fn is_match_raw(&self, public_key: &[u8; 32]) -> bool {
        match self {
            Self::RawPrefix {
                full_bytes,
                last_mask,
...
fn decode_raw_prefix(prefix_upper: &[u8]) -> Option<(Vec<u8>, u8, u8, usize)> {
...
fn build_prefix_matcher(prefix: Vec<u8>) -> AddressMatcher {
...
fn save(onion_address: &str, expanded_key: &[u8; 64], public_key: &[u8; 32]) {
